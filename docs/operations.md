...
`sqlguard` is centered on security tooling work in SQL. The technical target is: Detect unsafe query construction and verify parameterized alternatives.
...
The score is deterministic. The current threshold is 151. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 5.
