"""Regression checks for the sqlguard casebook."""
...
from casebook.harness import assert_expected, sqlguard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sqlguard_summary(), assert_expected())
